...
#define LCD_DEFAULT_BRIGHTNESS_VALUE 19
#define LCD_USER_ADJUSTABLE_BRIGHTNESS   //brightness adjustable in menu
#define LCD_MAX_BRIGHTNESS_VALUE 19      //undefine & change, if max != 21
