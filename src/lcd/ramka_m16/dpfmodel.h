...
// Type: ramka_m16
//
// Comment: "Menu-Off" does not work.
//
// Status: supported
// Credit: By superelchi, thx firefox
// Date: 2014-07-22
//
// The signature identify.py detected (OpenWin, Init, Backlight, Contrast)
// CRC: 0xa27e3c21, 0xdecbb6df, 2, 2
//
//
...
#define LCD_MAX_CONTRAST_VALUE 6        // NOTE from identify.py: value not detected
