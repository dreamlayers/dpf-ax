...
#define LCD_MAX_CONTRAST_VALUE 7           // NOTE from identify.py: value not detected
...
#define LCD_TIMER1_PERIOD 0x0040  //custom value, standard table value = 0x0000
