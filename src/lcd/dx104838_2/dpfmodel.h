...
//
// Status: supported
// Credit: By superelchi (thx j3r, mihre)
// Url: http://www.dealextreme.com/p/stylish-a18-2-4-lcd-desktop-digital-photo-picture-frame-album-white-silver-16mb-104838
// 
// The signature identify.py detected (OpenWin, Init, Backlight, Contrast)
// CRC: 0xb48f20a1, 0xdb8e3308, 0, 0
//
//
