...
//
// Status: supported
// Credit: By superelchi, thx richard
// Date: 2013-07-21
//
// Url: http://cpc.farnell.com/jsp/search/productdetail.jsp?sku=CS1967434
//
// The signature identify.py detected (OpenWin, Init, Backlight, Contrast)
// CRC: 0x26290621, 0xff29634b, 2, 2
//
//
...
#define LCD_MAX_CONTRAST_VALUE 32          // NOTE from identify.py: value not detected
