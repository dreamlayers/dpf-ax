...
#define LCD_MAX_BRIGHTNESS_VALUE 12      // nonzhe reported that 12 = 100%, then brightness drops
                                         // can't find anything unusal, so limiting max to 12
