//
// Type: neckermann
// Comment: Gift from german seller neckermann.de (no longer available.)
//
// Status: supported
// Credit: By superelchi, thx Anaeijon 
// Date: 2013-06-27
//
// The signature identify.py detected (OpenWin, Init, Backlight, Contrast)
// CRC: 0x6cc8903b, 0x330d5a82, 2, 0
//
//
...
//#define LCD_MAX_CONTRAST_VALUE ???        // NOTE from identify.py: value not detected
